...
export default function Home() {
  ...
  const [mosaicArtistCount, setMosaicArtistCount] = useState(6);
  ...
  }, [font, bg, accent, from, to, footer, mosaicArtistCount, enableMosaic, textColorMode]);
  ...
  async function generateReport(forceFetch = false) {
    ...
    try {
      const resp = await fetch('/api/generate', {
        ...
        body: JSON.stringify({ font, bg, accent, from, to, footer, forceFetch, mosaicArtistCount, enableMosaic, textColorMode }),
      });
        ...
        <div style={formStyle}>
          ...
          <label style={labelStyle}>
            ...
            <select value={mosaicArtistCount} onChange={(e) => setMosaicArtistCount(parseInt(e.target.value))} style={selectStyle} disabled={!enableMosaic}>
              ...
              <option value={6}>6 artists</option>
            </select>
          </label>

          {/* Enable mosaic toggle */}
          <label style={{ ...labelStyle, flexDirection: 'row', alignItems: 'center', gap: '8px' }}>
            ...
            />
            <span style={labelTextStyle}>Enable Top Artists Mosaic</span>
          </label>
